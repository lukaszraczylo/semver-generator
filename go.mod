...
require (
	...
	github.com/lukaszraczylo/ask v0.0.0-20230407165749-41ac0d88c13d
	github.com/lukaszraczylo/go-simple-graphql v1.1.30
	github.com/lukaszraczylo/pandati v0.0.27
